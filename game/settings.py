...
LOGOUT_REDIRECT_URL = '/zuser/login/'  # Set this to the desired redirect URL after logout
...
DATA_UPLOAD_MAX_NUMBER_FIELDS = 10000  # Adjust as needed
...
CLOUD_APP_LOGIN_URL_LOCAL = 'http://127.0.0.1:8000/receive-localhost/'
